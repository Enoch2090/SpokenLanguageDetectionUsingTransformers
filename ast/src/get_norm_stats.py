...
audio_conf = {'num_mel_bins': 128, 'target_length': 512, 'freqm': 24, 'timem': 192, 'mixup': 0.5, 'skip_norm': True, 'mode': 'train', 'dataset': 'audioset'}

# import os
# print(os.getcwd())

train_loader = torch.utils.data.DataLoader(
    dataloader.AudiosetDataset('/root/autodl-tmp/ast/egs/audioset/data/datafiles/train_data.json', label_csv='/root/autodl-tmp/ast/egs/audioset/data/class_labels_indices.csv',
